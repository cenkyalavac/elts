...
import { 
    ...
    Globe, Briefcase, Calendar 
} from "lucide-react";

export default function JobFilters({ filters, onFilterChange, jobs }) {
    ...
    const allLanguages = [...new Set(
        jobs.flatMap(j => j.required_languages?.map(l => l.language) || [])
    )].sort();

    const allSpecializations = [...new Set(
        jobs.flatMap(j => j.required_specializations || [])
    )].sort();
        ...
        <Card>
            <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                        ...
                        <div className="border-t pt-4">
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    ...
                                    <Label className="text-sm cursor-pointer">Required Languages</Label>
                                    {filters.selectedLanguages?.length > 0 && (
                    ...
                    {/* Min Experience */}
                    <div className="border-t pt-4">
                        <Label htmlFor="minExp" className="text-sm">Min Experience (years)</Label>
                        <Input
                            id="minExp"
                            type="number"
                            min="0"
                    ...
                    <div className="border-t pt-4">
                        <div className="flex items-center gap-2">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) => onFilterChange({ ...filters, hasDeadline: checked })}
                            />
                            <label htmlFor="hasDeadline" className="text-sm cursor-pointer flex items-center gap-1">
